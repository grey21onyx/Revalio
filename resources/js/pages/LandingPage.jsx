...
const LandingPage = () => {
  ...
  // Pass scroll refs to Navbar for smooth scrolling
  const scrollRefs = {
    featuresRef,
    aboutSectionRef,
  ...
  return (
    <Box sx={{ backgroundColor: '#f8f9fa' }}>
      {/* Use the LandingPageNavbar component */}
      <LandingPageNavbar scrollRefs={scrollRefs} />
      ...
      {/* Use the LandingPageFooter component */}
      <LandingPageFooter />
